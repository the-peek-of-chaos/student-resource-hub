...
const Lang = (function () {
  ...
  const translations = {
    en: {
      ...
      // Tools page
      tools_title: "Interactive Mini Tools",
      tools_subtitle: "Handy utilities to make your study sessions more productive.",
    ...
    ar: {
      ...
      tools_title: "أدوات مصغرة تفاعلية",
      tools_subtitle: "أدوات مفيدة لجعل جلسات دراستك أكثر إنتاجية.",
